...
//Will use the cat object provided by getSingleCatObject to create HTML string which it will render to the dom
function renderCat() {
...
//Returns an array of cat objects that meets the user's criteria
